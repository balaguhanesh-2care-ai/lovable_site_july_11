...
const RequestDemoCallForm = ({ onSuccess }: RequestDemoCallFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/request-demo-call", {
        method: "POST",
  ...
  if (submissionStatus === "success") {
    return (
      <div className="text-center p-4">
        ...
        <p className="text-green-600">Your demo request has been sent successfully.</p>
      </div>
    );
  }
...
export default RequestDemoCallForm;