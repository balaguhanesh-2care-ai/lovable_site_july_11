      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 mb-6">
            Welcome to 2Care.ai. These Terms and Conditions govern your use of our website and services. By accessing or using our services, you agree to be bound by these terms.
          </p>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>Permission is granted to temporarily download one copy of the materials on 2Care.ai's website for personal, non-commercial transitory viewing only</li>
          ...
          <p className="text-gray-700 mb-4">
            The materials on 2Care.ai's website are provided on an 'as is' basis. 2Care.ai makes no warranties, 
          ...
          <p className="text-gray-700 mb-4">
            In no event shall 2Care.ai or its suppliers be liable for any damages (including, without limitation, 
            damages for loss of data or profit, or due to business interruption) arising out of the use or inability 
            to use the materials on 2Care.ai's website, even if 2Care.ai or a 2Care.ai authorized representative has 
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">6. User Accounts</h2>
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
