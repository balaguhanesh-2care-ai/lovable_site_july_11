      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 mb-6">
            At 2Care.ai, we are committed to protecting your privacy. This Privacy Policy explains how we collect, 
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>Health-related data (when relevant to our services)</li>
          </ul>
          ...
          <p className="text-gray-700 mb-4">We use collected information for various purposes:</p>
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>With healthcare providers (when applicable and with consent)</li>
          </ul>
          ...
          <p className="text-gray-700 mb-4">
            ...
            through your browser settings, though some features may not function properly if cookies are disabled.
          </p>
